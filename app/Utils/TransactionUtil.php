...
class TransactionUtil extends Util
{
    ...
    public function getReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type)
    {
        ...
        // Inside the getReceiptDetails method
        $output['customer_custom_fields_vp'] = []; // For V.P table
        $output['customer_custom_fields_vl'] = []; // For V.L table
        $output['customer_custom_fields_ep'] = []; // For E.P table
        ...
        if ($il->show_customer == 1) {
            ...
            $temp_vp = []; // For V.P table
            $temp_vl = []; // For V.L table
            $temp_ep = []; // For E.P table
            ...
            if (!empty($customer->custom_field1) && in_array('custom_field1', $customer_custom_fields_settings)) {
                $label = !empty($contact_custom_labels['custom_field_1']) ? $contact_custom_labels['custom_field_1'] : 'Field 1';
                $temp_vp[] = ['label' => $label, 'value' => $customer->custom_field1];
            }
            if (!empty($customer->custom_field2) && in_array('custom_field2', $customer_custom_fields_settings)) {
                $label = !empty($contact_custom_labels['custom_field_2']) ? $contact_custom_labels['custom_field_2'] : 'Field 2';
                $temp_vp[] = ['label' => $label, 'value' => $customer->custom_field2];
            }
        
            // Custom fields for V.L table
            if (!empty($customer->custom_field3) && in_array('custom_field3', $customer_custom_fields_settings)) {
                $label = !empty($contact_custom_labels['custom_field_3']) ? $contact_custom_labels['custom_field_3'] : 'Field 3';
                $temp_vl[] = ['label' => $label, 'value' => $customer->custom_field3];
            }
            if (!empty($customer->custom_field4) && in_array('custom_field4', $customer_custom_fields_settings)) {
                $label = !empty($contact_custom_labels['custom_field_4']) ? $contact_custom_labels['custom_field_4'] : 'Field 4';
                $temp_vl[] = ['label' => $label, 'value' => $customer->custom_field4];
            }
        
            // Custom fields for E.P table
            if (!empty($customer->custom_field5) && in_array('custom_field5', $customer_custom_fields_settings)) {
                $label = !empty($contact_custom_labels['custom_field_5']) ? $contact_custom_labels['custom_field_5'] : 'Field 5';
                $temp_ep[] = ['label' => $label, 'value' => $customer->custom_field5];
            }
            if (!empty($customer->custom_field6) && in_array('custom_field6', $customer_custom_fields_settings)) {
                $label = !empty($contact_custom_labels['custom_field_6']) ? $contact_custom_labels['custom_field_6'] : 'Field 6';
                $temp_ep[] = ['label' => $label, 'value' => $customer->custom_field6];
            }
            ...
            // Assign to output
            if (!empty($temp_vp)) {
                $output['customer_custom_fields_vp'] = $temp_vp;
            }
            if (!empty($temp_vl)) {
                $output['customer_custom_fields_vl'] = $temp_vl;
            }
            if (!empty($temp_ep)) {
                $output['customer_custom_fields_ep'] = $temp_ep;
            }
            if (! empty($temp)) {
