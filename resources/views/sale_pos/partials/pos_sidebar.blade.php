<div class="simple-pos-sidebar-panel">
    <h2 class="simple-pos-page-heading">Produits rapides</h2>
            ...
            <div class="tw-dw-drawer tw-dw-drawer-end">
                ...
                <div class="tw-dw-drawer-content">
                    ...
                    <label for="my-drawer-4"
                        class="simple-filter-trigger lg:tw-w-[98%] tw-w-full tw-flex tw-items-center tw-justify-center tw-gap-1 tw-text-base md:tw-text-lg tw-font-semibold tw-rounded-xl tw-h-12 tw-cursor-pointer">
                ...
                <div class="tw-dw-drawer-side" style="z-index: 4000">
                    ...
                    <div class="tw-dw-menu tw-w-2/4 tw-min-h-full tw-bg-white tw-p-6 simple-filter-drawer">
                        <div class="tw-flex tw-items-center tw-mb-16">
                            ...
                            <h3 class="tw-text-center tw-flex-grow mx-auto category_heading tw-inline-block tw-font-bold tw-text-base md:tw-text-2xl simple-filter-title"
                        ...
                        <div class="row tw-mr-5">
                            <div class="col-md-3 col-xs-12 tw-mb-7 tw-w-auto  tw-h-auto tw-cursor-pointer  main-category-div main-category no-print"
                                ...
                                <div class="tw-dw-card tw-w-25 tw-bg-base-100 tw-shadow-sm tw-h-auto tw-cursor-pointer !tw-text-xs md:!tw-text-sm tw-font-semibold tw-text-center tw-border-2 simple-filter-card">
                            ...
                            @foreach ($categories as $category)
                                    <div class="col-md-3 col-xs-12 tw-mb-7 tw-w-auto  tw-h-28  tw-cursor-pointer main-category-div  no-print"
                                        ...
                                        <div
                                            class="tw-dw-card tw-w-25 tw-bg-base-100 tw-shadow-sm tw-h-auto tw-cursor-pointer tw-text-xs md:tw-text-sm tw-font-semibold !tw-text-center tw-border-2 simple-filter-card">
            ...
            <div class="tw-dw-drawer tw-dw-drawer-end">
                ...
                <div class="tw-dw-drawer-side" style="z-index: 4000">
                    ...
                    <div class="tw-dw-menu tw-w-2/4 tw-min-h-full tw-bg-white tw-p-6 simple-filter-drawer">
                        ...
                        <div class="tw-flex tw-items-center tw-mb-16">
                            <h3 class="tw-text-center tw-mx-auto tw-font-bold tw-text-base md:tw-text-2xl tw-mb-16 simple-filter-title"
